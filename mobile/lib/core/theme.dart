...
class NeonColors {
  ...
  static const surfaceGlass = Color(0x8811121F);
    ...
    return base.copyWith(
      ...
      cardTheme: CardTheme(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: NeonColors.purple.withOpacity(.18)),
        ),
      ),
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: NeonColors.surface,
        border: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide(color: NeonColors.purple.withOpacity(.25))),
        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide(color: NeonColors.purple.withOpacity(.25))),
        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: const BorderSide(color: NeonColors.blue, width: 1.6)),
      ),
      bottomNavigationBarTheme: const BottomNavigationBarThemeData(
        backgroundColor: NeonColors.surface,
        selectedItemColor: NeonColors.blue,
